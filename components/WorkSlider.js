    ...
    {workSlider.slides.map((slide,index)=>{
      return (
          <SwiperSlide key={ index}>
            <div className={'grid grid-cols-2 grid-row-2 gap-4 cursor-pointer'}>{slide.images.map((image, index)=>{
              return <div className={'relative rounded-lg overflow-hidden flex items-center group'} key={index}>
